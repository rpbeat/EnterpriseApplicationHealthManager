  ...
  public String login () {
    ...
    try {
      ...
      //FUCK THIS SHIT!!!!!
        ...
        Administrador admin = new Administrador(this.username, this.password, "ruben", "asdasd@asdas.com");
        List<AdministradorDTO> list = adminManager.getAllAdministradoresDTO();
